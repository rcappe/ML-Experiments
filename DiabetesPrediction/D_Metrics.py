...
class Metrics:
    ...
    def __init__(self, data, classifier):
        ...
        # Accuracy
        print()
        print("Accuracy: {0:.4f}".format(metrics.accuracy_score(data.y_train, nb_predict_train)))
        ...
        # training metrics
        print("Accuracy: {0:.4f}".format(metrics.accuracy_score(data.y_test, nb_predict_test)))
        print("")
